...
namespace MindTouch.RoslynAnalyzers.MindTouchEnumSwitchAnalyzer {
    ...
    public class MindTouchEnumSwitchAnalyzer : DiagnosticAnalyzer {
        ...
        //--- Constants ---
        public const string DIAGNOSTIC_ID = "MindTouchEnumSwitchAnalyzer";
        private const string Category = "Correctness";

        //--- Class Fields ---
        private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Resources.MindTouchEnumSwitchAnalyzerTitle), Resources.ResourceManager, typeof(Resources));
        private static readonly LocalizableString MessageFormat = new LocalizableResourceString(nameof(Resources.MindTouchEnumSwitchAnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));
